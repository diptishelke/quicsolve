            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <h2 class="mb-0">
                        ...
                        <label style="font-size: 16px;" class="float-end badge bg-danger trending_tag">Trending</lable>
                        @endif
                    </h2>
                    <hr>
                    <label class ="me-3">original_price:<s> Rs{{$products->original_price}}</s></label>
