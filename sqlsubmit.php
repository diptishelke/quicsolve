...
<td><a href="update.php?id=$val[personID]&fn=$val[FirstName]&ln=$val[LastName]&ad=$val[Address]&ct=$val[City]&gd=$val[Gender]&hb=$val[Hobbies]">Edit/update</a></td>
<td><a href="delete.php?pi=$val[personID]">delete</a></td>
<?php
}?>
</tbody>
</table>